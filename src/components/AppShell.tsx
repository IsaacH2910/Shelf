  ...
  return (
    <div className="flex h-dvh min-h-0 w-full flex-1 overflow-hidden bg-bg">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-border bg-bg px-4 py-3 min-[720px]:hidden">
        ...
        <main className="min-h-0 flex-1 overflow-hidden pb-20 min-[720px]:pb-0">{children}</main>
      </div>

      <nav className="fixed inset-x-0 bottom-0 z-30 flex border-t border-border bg-surface pb-[env(safe-area-inset-bottom)] min-[720px]:hidden">
